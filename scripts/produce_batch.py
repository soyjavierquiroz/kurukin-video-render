...
def make_manifest(
    ...
    *,
    ...
    material_title: str = "",
    source_policy: str = "",
    material_source_policy: dict[str, Any] | None = None,
    atlas_title_id: str | None = None,
    ...
    payload = {
        ...
        # These are the current explicit discovery contract.  The legacy
        # title/source fields above remain for existing batch callers.
        "material_source_policy": material_source_policy,
        "atlas_title_id": atlas_title_id,
